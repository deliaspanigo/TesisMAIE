...
def setup_goes16_spi301_MIX01_convert_tiff2png_v01(selected_setup):
    principal_dic = {
        "f00": {
            ...
            "new_format": ".png",
            "new_tail": "_tiff2png2png_spi301_ppi006_v001_dom000_OrigProj.png",
            "prefix_file_name" : "OR_ABI-L2-MCMIPF",
            "subfolder_prod_info": "spi301_MIX001/",
            "subfolder_version": "spi301_ppi006_tiff2png_v006_dom000_OrigProj/",
            "abrev_name": "MIX001"
...
def convert_goes16_spi301_ppi006_gen02_OneDay_HardCoded(gregorian_date = None):
