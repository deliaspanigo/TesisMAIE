...
def setup_goes16_spi301_MIX01_convert_nc2png_v01(selected_setup):
    principal_dic = {
        "f00": {
            "product_name": "",
            "original_format": ".nc",
            "new_format": ".png",
            "new_tail": "_nc2png_spi301_ppi001_v001_dom000_OrigProj.png",
            "prefix_file_name" : "OR_ABI-L2-MCMIPF",
            "subfolder_prod_info": "spi301_MIX001/",
            "subfolder_version": "spi301_ppi001_nc2png_v001_dom000_OrigProj/",
            "abrev_name": "MIX001"
...
def convert_nc2png_goes16_spi301_MIX01_v01_gen01(selected_input_path01, selected_input_path02, selected_output_path, plot_me = True, save_me = True, overwrite = False):
    ...
    ax.set_title('{} - {} [{}]'.format(sat,selected_product02, unit_var02), fontsize=7, loc='left')
...
############
def convert_nc2png_goes16_spi301_MIX01_v01_gen02_OneDay_Simple(input_folder, output_folder, gregorian_date, plot_me, save_me, overwrite):

    print("Start: convert_nc2png_goes16_spi301_MIX01_v01_gen02_OneDay_Simple()")
    
    key_png_setup = "f00"
    selected_png_setup = setup_goes16_spi301_MIX01_convert_nc2png_v01(key_png_setup)
    ...
    for x in range(total_files):
        ...
        if not dt_exists:
            convert_nc2png_goes16_spi301_MIX01_v01_gen01(selected_input_path01, 
                                                     selected_input_path02,
                                                     selected_output_path,
                                                plot_me, save_me, overwrite)
        
            
    print("Close: convert_nc2png_goes16_spi301_MIX01_v01_gen02_OneDay_Simple()")
...
def convert_goes16_spi301_ppi001_gen02_OneDay_HardCoded(gregorian_date = None):
    
    print('Start: convert_nc2png_goes16_sspi301_MIX01_v01_gen02_OneDay_HardCoded()')
    ...
    # Download - gen02
    convert_nc2png_goes16_spi301_MIX01_v01_gen02_OneDay_Simple(input_folder, output_folder, gregorian_date, plot_me, save_me, overwrite)

    print('Close: convert_nc2png_goes16_sspi301_MIX01_v01_gen02_OneDay_HardCoded()')
...
if False:
    def convert_nc2png_goes16_spi301_MIX01_v01_gen03_OneDay_Simple(input_folder, output_folder, gregorian_date, plot_me, save_me, overwrite):

        print("Start: convert_nc2png_goes16_spi301_MIX01_v01_gen03_OneDay_Simple()")
        ...
        total_files = len(input_paths02)

        # All arguments in tuplas
        combined_tuplas = list(zip(input_paths01, output_paths,
                                    [plot_me]*total_files, [save_me]*total_files, [overwrite]*total_files))


        # Gen 03!!!
        my_function = convert_nc2png_goes16_spi301_MIX01_v01_gen01
        ...
        print("Close: convert_nc2png_goes16_spi301_MIX01_v01_gen03_OneDay_Simple()")
        
        return



    def convert_nc2png_goes16_spi301_MIX01_v01_gen03_OneDay_HardCoded(gregorian_date = None):
        
        print('Start: convert_nc2png_goes16_spi301_MIX01_v01_gen03_OneDay_HardCoded()')
        ...
        # Download - gen02
        convert_nc2png_goes16_spi301_MIX01_v01_gen03_OneDay_Simple(input_folder, output_folder, gregorian_date, plot_me, save_me, overwrite)

        print('Close: convert_nc2png_goes16_spi301_MIX01_v01_gen03_OneDay_HardCoded()')
    ...
    def convert_nc2png_goes16_spi301_MIX01_v01_gen03_RangeDate_HardCoded(init_gregorian_date, end_gregorian_date):
        
        print('Start: convert_nc2png_goes16_spi301_MIX01_v01_gen03_RangeDate_HardCoded()')
        ...
        for x in gregorian_list:
            convert_nc2png_goes16_spi301_MIX01_v01_gen03_OneDay_HardCoded(gregorian_date = x)
            
        print('Close: convert_nc2png_goes16_spi301_MIX01_v01_gen03_RangeDate_HardCoded()')
