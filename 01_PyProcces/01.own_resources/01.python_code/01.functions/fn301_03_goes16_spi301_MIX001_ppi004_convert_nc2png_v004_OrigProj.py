...
def setup_goes16_spi301_MIX01_convert_nc2png_v04(selected_setup):
    principal_dic = {
        "f00": {
            "product_name": "",
            "original_format": ".nc",
            "new_format": ".png",
            "new_tail": "_nc2png_spi301_ppi004_v004_dom000_OrigProj.png",
            "prefix_file_name" : "OR_ABI-L2-MCMIPF",
            "subfolder_prod_info": "spi301_MIX001/",
            "subfolder_version": "spi301_ppi004_nc2png_v004_dom000_OrigProj/",
            "abrev_name": "MIX001"
...
def convert_nc2png_goes16_spi301_MIX01_v04_gen01(selected_input_path01, selected_input_path02, selected_output_path, plot_me = True, save_me = True, overwrite = False):
...
############
def convert_nc2png_goes16_spi301_MIX01_v04_gen02_OneDay_Simple(input_folder, output_folder, gregorian_date, plot_me, save_me, overwrite):

    print("Start: convert_nc2png_goes16_spi301_MIX01_v04_gen02_OneDay_Simple()")
    
    key_png_setup = "f00"
    selected_png_setup = setup_goes16_spi301_MIX01_convert_nc2png_v04(key_png_setup)
    ...
    for x in range(total_files):
        ...
        if not dt_exists:
            convert_nc2png_goes16_spi301_MIX01_v04_gen01(selected_input_path01, 
                                                     selected_input_path02,
                                                     selected_output_path,
                                                plot_me, save_me, overwrite)
        
            
    print("Close: convert_nc2png_goes16_spi301_MIX01_v04_gen02_OneDay_Simple()")
...
def convert_goes16_spi301_ppi004_gen02_OneDay_HardCoded(gregorian_date = None):
    
    print('Start: convert_goes16_spi301_ppi004_gen02_OneDay_HardCoded()')
    ...
    # Download - gen02
    convert_nc2png_goes16_spi301_MIX01_v04_gen02_OneDay_Simple(input_folder, output_folder, gregorian_date, plot_me, save_me, overwrite)

    print('Close: convert_goes16_spi301_ppi004_gen02_OneDay_HardCoded()')
