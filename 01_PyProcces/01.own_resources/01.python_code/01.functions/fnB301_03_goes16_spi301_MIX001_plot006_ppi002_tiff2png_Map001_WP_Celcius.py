...
def standard_plot_Hardcoded(gregorian_date):
    ...
    pdict["plot"] = "plot006"
    pdict["ppi"] =  "ppi002"
    pdict["label"] = "tiff2png_Map001_WP_Celcius"
    pdict["input_ext_file_s01"] =  ".tiff"
    pdict["input_ext_file_s02"] =  ".tiff"
...
def standard_input_OneDay_Hardcoded(gregorian_date = None):
    ...
    input_folder_s02 = info_nc2tiff_output_s02["output_folder"]
    list_spected_input_files_s02 = info_nc2tiff_output_s02["list_spected_output_files"]
    list_spected_input_paths_s02 = info_nc2tiff_output_s02["list_spected_output_paths"]

    
    # # # Pack on dictionary
    pdict = {
        "gregorian_date": gregorian_date, 
        "spi_and_name_01": info_nc2tiff_output_s01["spi_and_name_01"],
